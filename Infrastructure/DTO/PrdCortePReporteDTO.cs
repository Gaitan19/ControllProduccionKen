...
{
    public  class PrdCortePReporteDTO
    {
        // Encabezado
        ...
        // Detalles
        public List<DetalleCortePDto> Detalles { get; set; } = new List<DetalleCortePDto>();
    }

    /// <summary>
    /// DTO de detalle para cada registro en DetPrdCorteP.
    /// </summary>
    public class DetalleCortePDto
    {
        /// <summary>
        /// Id de la cabecera (PrdCorteP).
        /// </summary>
        public int IdCorteP { get; set; }
