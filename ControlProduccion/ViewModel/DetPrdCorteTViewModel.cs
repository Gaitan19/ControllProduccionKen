...
{
    public class DetPrdCorteTViewModel
    {
        //debido a que la tabla padre ya tiene un id, se nombra diferente este id para que no genere conflicto en el fronted. pero este campo es el Id(DetPrdCorteTId) del detalle
        public int DetPrdCorteTId { get; set; }

        [Display(Name = "Producción Corte T")]
        public int PrdCorteTid { get; set; }
