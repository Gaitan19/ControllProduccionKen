CREATE TABLE [cp].[DetAlambrePrdPanelesCovintec] (
    ...
    CONSTRAINT [FK_DetAlambrePrdPanelesCovintec_Principal] FOREIGN KEY ([IdPanel]) REFERENCES [cp].[PrdPanelesCovintec] ([Id])
);
